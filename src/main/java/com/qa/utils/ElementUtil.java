...
public class ElementUtil {
	...
	public boolean isElementCheck(By locator) {
		try {
			...
			log.error("Element is not found on the page: " + locator);
	...
	public boolean isElementDisplayed(By locator) {
		try {
			...
			log.error("Element is not displayed on the page using locator: " + locator);
			return false;
		}
	}
	...
	public boolean isElementDisplayed(WebElement element) {
		try {
			...
			log.error("Element is not displayed on the page using Web Element: " + element);
			return false;
		}
	}
	...
	public boolean isElementEnabled(By locator) {
		try {
			...
			log.error("Element is not enabled on the page using locator: " + locator);
			return false;
		}
	}
	...
	public WebElement getElement(By locator) {
		...
		if(DriverFactory.highlightElement.equalsIgnoreCase("true")) {
	...
	public boolean isElementExist(By locator) {
		if (getElementsCount(locator) == 1) {
			log.info("the element : " + locator + " is present on the page");
			return true;
		} else {
			log.info("the element : " + locator + " is not present on the page");
			return false;
		}
	}
	...
	public boolean isElementExist(By locator, int expectedEleCount) {
		if (getElementsCount(locator) == expectedEleCount) {
			log.info("the element : " + locator + " is present on the page " + expectedEleCount + " times");
			return true;
		} else {
			log.info("the element : " + locator + " is not present on the page " + expectedEleCount + " times");
			return false;
		}
	}
	...
	public List<String> getDropDownValuesList(By locator) {
		...
		log.info("total number of options in the drop down: " + optionsList.size());
	...
	public String waitForTitleContains(String fractionTitleValue, int timeout) {
		...
		try {
			...
			log.info("expected title value : " + fractionTitleValue + " is not present");
		}
	...
	public String waitForTitleIs(String expectedTitleValue, int timeout) {
		...
		try {
			...
			log.info("expected title value : " + expectedTitleValue + " is not present");
		}
	...
	public String waitForURLContains(String fractionURLValue, int timeout) {
		...
		try {
			...
			log.info("expected URL value : " + fractionURLValue + " is not present");
		}
	...
	public String waitForURLIs(String epxectedURLValue, int timeout) {
		...
		try {
			...
			log.info("expected URL value : " + epxectedURLValue + " is not present");
		}
	...
	public boolean waitForWindow(int expectedNoOfWindows, int timeout) {
		...
		try {
			...
			log.info("expected number of windows: " + expectedNoOfWindows + " is not present");
			return false;
		}
	}
	...
	public boolean waitForFrame(By frameLocator, int timeout) {
		...
		try {
			...
			log.info("frame is not present on the page using locator: " + frameLocator);
			return false;
		}
	...
	public boolean waitForFrame(int frameIndex, int timeout) {
		...
		try {
			...
			log.info("frame is not present on the page using frame index: " + frameIndex);
			return false;
		}
	...
	public boolean waitForFrame(String frameNameOrID, int timeout) {
		...
		try {
			...
			log.info("frame is not present on the page using frame name or ID: " + frameNameOrID);
			return false;
		}

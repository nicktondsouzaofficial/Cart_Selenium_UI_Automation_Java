...
public class Registration {
	...
	public boolean userRegister(String firstName, String lastName, String email, String telephone, String password,
		...
		eleUtil.waitForElementVisible(this.firstName, AppConstant.DEFAULT_SHORT_WAIT).sendKeys(firstName);
		...
		String successMesg = eleUtil.waitForElementVisible(successMessg, AppConstant.DEFAULT_MEDIUM_WAIT).getText();
